...
/* Enter the book details like title, author, publisher, price and no of copies 0f each book.  Search the particular book and accept that copies, if available then 
   display the total price of book copies. */
